    ...
    private void initClick() {
        ...
        tvSbzt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PickerViewUtils.selectOptions(com.suncreate.shinyportal.activity.SelectAssetEquipmentActivity.this, "选择", optionsList4, null, null, new PickerViewSelectOptionsResult() {
                    @Override
