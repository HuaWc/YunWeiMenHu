...
import com.suncreate.shinyportal.entity.EventTrackInfo;
 ...
 */
public class EventTrackAdapter extends BaseQuickAdapter<EventTrackInfo, BaseViewHolder> {
    public EventTrackAdapter(@Nullable List<EventTrackInfo> data) {
